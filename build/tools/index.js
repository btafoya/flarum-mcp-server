    ...
    try {
        switch (name) {
            ...
            case "flarum_update_tag": {
                ...
                const parentIdInput = args.parentId;
                const updatedTag = await flarumClient.updateTag(args.id, {
                    name: args.name,
                    slug: args.slug,
                    description: args.description,
                    color: args.color,
            ...
            case "flarum_delete_tag": {
                ...
                await flarumClient.deleteTag(args.id);
                return {
                    content: [jsonText({
                            success: true,
            ...
            case "flarum_update_user": {
                ...
                const updatedUser = await flarumClient.updateUser(args.id, {
                    username: args.username,
                    email: args.email,
                    password: args.password,
                    bio: args.bio,
            ...
            case "flarum_delete_user": {
                ...
                await flarumClient.deleteUser(args.id);
                return {
                    content: [jsonText({
                            success: true,
